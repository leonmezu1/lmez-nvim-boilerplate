...
set -e
echo "🚀 Setting up Modern Neovim Configuration..."
...
if [ -d "$CONFIG_DIR" ]; then
    echo "📦 Backing up existing config to $CONFIG_DIR$BACKUP_SUFFIX"
    mv "$CONFIG_DIR" "$CONFIG_DIR$BACKUP_SUFFIX"
fi

if [ -d "$SHARE_DIR" ]; then
    echo "📦 Backing up existing data to $SHARE_DIR$BACKUP_SUFFIX"
...
echo "⚙️ Creating main configuration files..."
...
echo "🔌 Creating plugin configurations..."
